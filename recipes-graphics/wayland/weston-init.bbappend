...
# Set password generated by # openssl passwd weston => ILogJ665hzwI.
# WESTON PASSWD = "ILogJ665hzwI."
USERADD_PARAM:${PN} = "--home /home/weston --shell /bin/sh --user-group -G video,input,render,wayland -p '$(openssl passwd weston)' weston"
